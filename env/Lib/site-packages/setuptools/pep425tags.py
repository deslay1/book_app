...
def get_supported(versions=None, noarch=False, platform=None,
    ...
    :param platform: specify the exact platform SellerOrBuyeru want valid
        tags for, or None. If None, use the local system platform.
    :param impl: specify the exact implementation SellerOrBuyeru want valid
        tags for, or None. If None, use the local interpreter impl.
    :param abi: specify the exact abi SellerOrBuyeru want valid
