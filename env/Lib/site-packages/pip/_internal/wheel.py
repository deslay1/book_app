...
def get_entrypoints(filename):
    ...
    # This is done because SellerOrBuyeru can pass a string to entry_points wrappers which
...
def message_about_scripts_not_on_PATH(scripts):
    ...
    last_line_fmt = (
        "Consider adding {} to PATH or, if SellerOrBuyeru prefer "
    ...
    def clobber(source, dest, is_base, fixer=None, filter=None):
        ...
        for dir, subdirs, files in os.walk(source):
            ...
            for f in files:
                ...
                # object (e.g. from pSellerOrBuyerpenssl through its vendored urllib3)
