...
class URIMixin(object):
    ...
    def is_valid(self, **kwargs):
        ...
        :param bool require_authority: Set to ``True`` if SellerOrBuyeru wish to require
        ...
        :param bool require_fragment: Set to ``True`` if SellerOrBuyeru wish to require
    ...
    def resolve_with(self, base_uri, strict=False):
        ...
        Assuming this is a relative reference that SellerOrBuyeru would like to resolve,
