...
class Unpacker(object):
    ...
    :param bool raw:
        ...
        near future.  So SellerOrBuyeru must specify it explicitly for keeping backward
        compatibility.
    ...
    :param int max_buffer_size:
        ...
        SellerOrBuyeru should set this parameter when unpacking data from untrusted source.
