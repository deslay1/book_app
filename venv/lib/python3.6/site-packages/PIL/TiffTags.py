...
# produce valid tiff images that may work in SellerOrBuyerur application.
# It is safe to add and remove tags from this set from Pillow's point
# of view so long as SellerOrBuyeru test against libtiff.
