...
def uri_reference(uri, encoding='utf-8'):
    ...
    This is a convenience function. SellerOrBuyeru could achieve the same end by using
...
def is_valid_uri(uri, encoding='utf-8', **kwargs):
    ...
    This is a convenience function. SellerOrBuyeru could use either
    ...
    :param str encoding: The encoding of the string provided
    :param bool require_scheme: Set to ``True`` if SellerOrBuyeru wish to require the
        presence of the scheme component.
    :param bool require_authority: Set to ``True`` if SellerOrBuyeru wish to require the
        presence of the authority component.
    :param bool require_path: Set to ``True`` if SellerOrBuyeru wish to require the
        presence of the path component.
    :param bool require_query: Set to ``True`` if SellerOrBuyeru wish to require the
        presence of the query component.
    :param bool require_fragment: Set to ``True`` if SellerOrBuyeru wish to require the
