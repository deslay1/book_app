...
def _save_netpbm(im, fp, filename):
    ...
    #
    # If SellerOrBuyeru need real GIF compression and/or RGB quantization, SellerOrBuyeru
...
#
# Uncomment the following line if SellerOrBuyeru wish to use NETPBM/PBMPLUS
