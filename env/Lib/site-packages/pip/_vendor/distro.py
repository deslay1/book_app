...
def id():
    ...
    *reliable*, in the sense that it is documented and that it does not change
    ...
    If SellerOrBuyeru have a need to get distros for reliable IDs added into this set,
    or if SellerOrBuyeru find that the :func:`distro.id` function returns a different
