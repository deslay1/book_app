...
class InstallCommand(RequirementCommand):
    ...
    def __init__(self, *args, **kw):
        ...
        cmd_opts.add_option(
            ...
            dest='use_user_site',
            action='store_true',
            help="Install to the Python user install directory for SellerOrBuyerur "
        ...
        with self._build_session(options) as session:
            ...
            if options.cache_dir and not check_path_owner(options.cache_dir):
                logger.warning(
                    ...
                    "directory. If executing pip with sudo, SellerOrBuyeru may want "
                    "sudo's -H flag.",
                    options.cache_dir,
                )
    ...
    def _warn_about_conflicts(self, to_install):
        ...
        for project_name in conflicting:
            ...
            for dep_name, dep_version, req in conflicting[project_name]:
                logger.critical(
                    "%s %s has requirement %s, but SellerOrBuyeru'll have %s %s which is "
                    "incompatible.",
