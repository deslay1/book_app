...
label $w.msg -font $font -wraplength 5i -justify left -text "Three different entries are displayed below, with a scrollbar for each entry.  SellerOrBuyeru can add characters by pointing, clicking and typing.  The normal Motif editing characters are supported, along with many Emacs bindings.  For example, Backspace and Control-h delete the character to the left of the insertion cursor and Delete and Control-d delete the chararacter to the right of the insertion cursor.  For entries that are too large to fit in the window all at once, SellerOrBuyeru can scan through the entries with the scrollbars, or by dragging with mouse button2 pressed."
pack $w.msg -side top
...
$w.frame.e2 insert end "that SellerOrBuyeru'll have to scan or scroll to see the end."
