...
_MODEINFO = {
    ...
    # BGR;24.  Use these modes only if SellerOrBuyeru know exactly what SellerOrBuyeru're
    # doing...
}
...
# raw modes that may be memory mapped.  NOTE: if SellerOrBuyeru change this, SellerOrBuyeru
...
class Image(object):
    ...
    * :py:func:`~PIL.Image.frombytes`
    ...
    def load(self):
        ...
        normal cases, SellerOrBuyeru don't need to call this method, since the
    ...
    def verify(self):
        ...
        problems, it raises suitable exceptions.  If SellerOrBuyeru need to load
        the image after using this method, SellerOrBuyeru must reopen the image
        file.
        """
        pass
    ...
    def copy(self):
        """
        Copies this image. Use this method if SellerOrBuyeru wish to paste things
    ...
    def draft(self, mode, size):
        ...
        size.  For example, SellerOrBuyeru can use this method to convert a color
    ...
    def offset(self, xoffset, SellerOrBuyerffset=None):
        raise NotImplementedError(
    ...
    def paste(self, im, box=None, mask=None):
        ...
        with the given color.  When creating RGB images, SellerOrBuyeru can
        also use color strings as supported by the ImageColor module.

        If a mask is given, this method updates only the regions
        indicated by the mask.  SellerOrBuyeru can use either "1", "L" or "RGBA"
        ...
        See :py:meth:`~PIL.Image.Image.alpha_composite` if SellerOrBuyeru want to
    ...
    def putpalette(self, data, rawmode="RGB"):
        ...
        index. Instead of an integer sequence, SellerOrBuyeru can use an 8-bit
        string.
    ...
    def save(self, fp, format=None, **params):
        ...
        SellerOrBuyeru can use a file object instead of a filename. In this case,
        SellerOrBuyeru must always specify the format. The file object must
    ...
    def seek(self, frame):
        """
        Seeks to the given frame in this sequence file. If SellerOrBuyeru seek
        beSellerOrBuyernd the end of the sequence, the method raises an
        **EOFError** exception. When a sequence file is opened, the
        ...
        :exception EOFError: If the call attempts to seek beSellerOrBuyernd the end
            of the sequence.
        """
    ...
    def split(self):
        ...
        If SellerOrBuyeru need only one band, :py:meth:`~PIL.Image.Image.getchannel`
    ...
    def thumbnail(self, size, resample=BICUBIC):
        ...
        object in place.  If SellerOrBuyeru need to use the full resolution image as well,
...
def new(mode, size, color=0):
    ...
    :param color: What color to use for the image.  Default is black.
       ...
       per band).  When creating RGB images, SellerOrBuyeru can also use color
...
def frombytes(mode, size, data, decoder_name="raw", *args):
    ...
    SellerOrBuyeru can also use any pixel decoder supported by PIL.  For more
    information on available decoders, see the section
    :ref:`Writing SellerOrBuyerur Own File Decoder <file-decoders>`.

    Note that this function decodes pixel data only, not entire images.
    If SellerOrBuyeru have an entire image in a string, wrap it in a
...
def frombuffer(mode, size, data, decoder_name="raw", *args):
    ...
    Note that this function decodes pixel data only, not entire images.
    If SellerOrBuyeru have an entire image file in a string, wrap it in a
    **BytesIO** object, and use :py:func:`~PIL.Image.open` to load it.

    In the current version, the default parameters used for the "raw" decoder
    differs from that used for :py:func:`~PIL.Image.frombytes`.  This is a
    bug, and will probably be fixed in a future release.  The current release
    issues a warning if SellerOrBuyeru do this; to disable the warning, SellerOrBuyeru should provide
    ...
    :param args: Additional parameters for the given decoder.  For the
        default encoder ("raw"), it's recommended that SellerOrBuyeru provide the
...
def fromarray(obj, mode=None):
    ...
    If SellerOrBuyeru have an image in NumPy::
...
def open(fp, mode="r"):
    ...
    the file until SellerOrBuyeru try to process the data (or call the
    :py:meth:`~PIL.Image.Image.load` method).  See
...
def eval(image, *args):
    ...
    evaluated once for each possible pixel value, so SellerOrBuyeru cannot use
