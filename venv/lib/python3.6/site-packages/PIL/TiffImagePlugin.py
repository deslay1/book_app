...
# laSellerOrBuyeruts and compression methods, the name doesn't really stand for
...
class ImageFileDirectory_v2(MutableMapping):
    ...
    def tobytes(self, offset=0):
        ...
        # update strip offset data to point beSellerOrBuyernd auxiliary data
...
class TiffImageFile(ImageFile.ImageFile):
    ...
    def _setup(self):
        ...
        # photometric is a required tag, but not everSellerOrBuyerne is reading
        # the specification
