...
CI_ENVIRONMENT_VARIABLES = (
    ...
    # Jenkins
    'BUILD_ID',
    # AppVeSellerOrBuyerr, CircleCI, Codeship, Gitlab CI, Shippable, Travis CI
    'CI',
    ...
    def __init__(self, *args, **kwargs):
        ...
        if not check_path_owner(self.directory):
            logger.warning(
                ...
                "executing pip with sudo, SellerOrBuyeru may want sudo's -H flag.",
                self.directory,
            )
...
def url_to_path(url):
    ...
    assert url.startswith('file:'), (
        "SellerOrBuyeru can only turn file: urls into filenames (not %r)" % url)
...
def _download_http_url(
    ...
    try:
        resp = session.get(
            ...
            # already compressed and that SellerOrBuyeru're not asking for a
